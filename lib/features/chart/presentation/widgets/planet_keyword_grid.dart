    ...
    for (final asteroid in asteroids) {
      if (keyAsteroids.contains(asteroid.name)) {
        items.add(_PlanetItem(
          ...
          keyword:
              _asteroidSignKeyword(asteroid.name, asteroid.sign, isZh),
...
const _zhKeywords = <String, String>{
  ...
  'Mercury:Libra': '思维公正', 'Mercury:Scorpio': '洞察入微', 'Mercury:Sagittarius': '思维开阔',
  'Mercury:Capricorn': '逻辑清晰', 'Mercury:Aquarius': '思维超前', 'Mercury:Pisces': '想象丰富',
  // Venus
...
const _enKeywords = <String, String>{
  'Sun:Aries': 'Bold Energy', 'Sun:Taurus': 'Steady', 'Sun:Gemini': 'Versatile',
  'Sun:Cancer': 'Nurturing', 'Sun:Leo': 'Confident', 'Sun:Virgo': 'Precise',
  'Sun:Libra': 'Harmonious', 'Sun:Scorpio': 'Intense', 'Sun:Sagittarius': 'Adventurous',
  'Sun:Capricorn': 'Ambitious', 'Sun:Aquarius': 'Innovative', 'Sun:Pisces': 'Dreamy',
  'Moon:Aries': 'Impulsive', 'Moon:Taurus': 'Secure', 'Moon:Gemini': 'Changeable',
  'Moon:Cancer': 'Sensitive', 'Moon:Leo': 'Passionate', 'Moon:Virgo': 'Cautious',
  'Moon:Libra': 'Balanced', 'Moon:Scorpio': 'Deep', 'Moon:Sagittarius': 'Optimistic',
  'Moon:Capricorn': 'Driven', 'Moon:Aquarius': 'Detached', 'Moon:Pisces': 'Intuitive',
  'Mercury:Aries': 'Quick Mind', 'Mercury:Taurus': 'Grounded', 'Mercury:Gemini': 'Witty',
  'Mercury:Cancer': 'Intuitive', 'Mercury:Leo': 'Expressive', 'Mercury:Virgo': 'Analytical',
  'Mercury:Libra': 'Diplomatic', 'Mercury:Scorpio': 'Perceptive', 'Mercury:Sagittarius': 'Broad',
  'Mercury:Capricorn': 'Logical', 'Mercury:Aquarius': 'Visionary', 'Mercury:Pisces': 'Imaginative',
  'Venus:Aries': 'Passionate', 'Venus:Taurus': 'Sensual', 'Venus:Gemini': 'Playful',
  'Venus:Cancer': 'Devoted', 'Venus:Leo': 'Generous', 'Venus:Virgo': 'Modest',
  'Venus:Libra': 'Charming', 'Venus:Scorpio': 'Loyal', 'Venus:Sagittarius': 'Free',
  'Venus:Capricorn': 'Committed', 'Venus:Aquarius': 'Independent', 'Venus:Pisces': 'Romantic',
  'Mars:Aries': 'Competitive', 'Mars:Taurus': 'Persistent', 'Mars:Gemini': 'Agile',
  'Mars:Cancer': 'Protective', 'Mars:Leo': 'Fierce', 'Mars:Virgo': 'Efficient',
  'Mars:Libra': 'Strategic', 'Mars:Scorpio': 'Relentless', 'Mars:Sagittarius': 'Daring',
  'Mars:Capricorn': 'Disciplined', 'Mars:Aquarius': 'Unconventional', 'Mars:Pisces': 'Gentle',
};

const _zhAscKeywords = <String, String>{
  'Aries': '果断先锋', 'Taurus': '沉稳优雅', 'Gemini': '机智灵活',
  'Cancer': '亲切感', 'Leo': '气场强大', 'Virgo': '谦逊细心',
  'Libra': '迷人和善', 'Scorpio': '神秘深邃', 'Sagittarius': '乐观热情',
  'Capricorn': '可靠沉稳', 'Aquarius': '特立独行', 'Pisces': '温柔梦幻',
};

const _enAscKeywords = <String, String>{
  'Aries': 'Pioneer', 'Taurus': 'Composed', 'Gemini': 'Curious',
  'Cancer': 'Warm', 'Leo': 'Radiant', 'Virgo': 'Humble',
  'Libra': 'Graceful', 'Scorpio': 'Mysterious', 'Sagittarius': 'Optimistic',
  'Capricorn': 'Reliable', 'Aquarius': 'Unique', 'Pisces': 'Gentle',
};

const _zhAsteroidDefaults = <String, String>{
  'North Node': '人生方向', 'Juno': '婚姻模式', 'Part of Fortune': '幸运所在',
};

const _enAsteroidDefaults = <String, String>{
  'North Node': 'Life Path', 'Juno': 'Partnership', 'Part of Fortune': 'Fortune',
};

const _zhAsteroidKeywords = <String, String>{
  'North Node:Aries': '学会独立', 'North Node:Taurus': '学会稳定',
  'North Node:Gemini': '学会沟通', 'North Node:Cancer': '学会照顾',
  'North Node:Leo': '学会自信', 'North Node:Virgo': '学会服务',
  'North Node:Libra': '学会合作', 'North Node:Scorpio': '学会深入',
  'North Node:Sagittarius': '学会探索', 'North Node:Capricorn': '学会担当',
  'North Node:Aquarius': '学会创新', 'North Node:Pisces': '学会信任',
  'Juno:Aries': '独立型', 'Juno:Taurus': '稳定型', 'Juno:Gemini': '沟通型',
  'Juno:Cancer': '家庭型', 'Juno:Leo': '浪漫型', 'Juno:Virgo': '服务型',
  'Juno:Libra': '平等型', 'Juno:Scorpio': '深入型', 'Juno:Sagittarius': '自由型',
  'Juno:Capricorn': '责任型', 'Juno:Aquarius': '创新型', 'Juno:Pisces': '浪漫型',
  'Part of Fortune:Aries': '独立自主', 'Part of Fortune:Taurus': '物质丰盛',
  'Part of Fortune:Gemini': '信息互通', 'Part of Fortune:Cancer': '家庭幸福',
  'Part of Fortune:Leo': '创意表现', 'Part of Fortune:Virgo': '精益求精',
  'Part of Fortune:Libra': '和谐关系', 'Part of Fortune:Scorpio': '深度转化',
  'Part of Fortune:Sagittarius': '自由探索', 'Part of Fortune:Capricorn': '事业成就',
  'Part of Fortune:Aquarius': '群体贡献', 'Part of Fortune:Pisces': '灵性成长',
};

const _enAsteroidKeywords = <String, String>{
  'North Node:Aries': 'Independence', 'North Node:Taurus': 'Stability',
  'North Node:Gemini': 'Communication', 'North Node:Cancer': 'Nurturing',
  'North Node:Leo': 'Self-expression', 'North Node:Virgo': 'Service',
  'North Node:Libra': 'Partnership', 'North Node:Scorpio': 'Depth',
  'North Node:Sagittarius': 'Exploration', 'North Node:Capricorn': 'Mastery',
  'North Node:Aquarius': 'Innovation', 'North Node:Pisces': 'Surrender',
  'Juno:Aries': 'Independent', 'Juno:Taurus': 'Stable', 'Juno:Gemini': 'Communicative',
  'Juno:Cancer': 'Domestic', 'Juno:Leo': 'Romantic', 'Juno:Virgo': 'Service',
  'Juno:Libra': 'Equal', 'Juno:Scorpio': 'Intense', 'Juno:Sagittarius': 'Free',
  'Juno:Capricorn': 'Committed', 'Juno:Aquarius': 'Unconventional', 'Juno:Pisces': 'Dreamy',
  'Part of Fortune:Aries': 'Self-reliance', 'Part of Fortune:Taurus': 'Abundance',
  'Part of Fortune:Gemini': 'Networking', 'Part of Fortune:Cancer': 'Home',
  'Part of Fortune:Leo': 'Creativity', 'Part of Fortune:Virgo': 'Mastery',
  'Part of Fortune:Libra': 'Harmony', 'Part of Fortune:Scorpio': 'Transformation',
  'Part of Fortune:Sagittarius': 'Freedom', 'Part of Fortune:Capricorn': 'Achievement',
  'Part of Fortune:Aquarius': 'Community', 'Part of Fortune:Pisces': 'Spirituality',
};
