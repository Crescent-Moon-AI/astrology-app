...
final chartCalculationServiceProvider =
    Provider<ChartCalculationService>((ref) {
  final engine = ref.watch(astroEngineProvider);
  return ChartCalculationService(engine);
});

final currentBirthDataProvider = Provider<BirthData?>((ref) {
  final profileAsync = ref.watch(userProfileProvider);
  return profileAsync.whenOrNull(data: (profile) {
