...
DailyFortune _fallbackFortune(DateTime date, String dateStr) {
  const sets = [
    {
      'title': '火花闪现 行动为先',
      'description': '下雨天，一周的最后，星星们似乎也安静了下来。如果前几天有些情绪的起伏或想法的碰撞，今天适合让一切慢慢沉淀。没有特别需要追赶的，也没有必须解决的。就像雨后的宁静，允许自己只是存在。整理这一周的思绪，或者干脆什么都不想，都是很好的休息。',
      'advice': '主动出击，把握机遇',
      'avoid': '犹豫不决，错失良机',
      'score': 86,
      'love': 91,
    ...
    {
      'title': '静水流深 以柔克刚',
      'description': '今天的星象显示，内在的力量远胜于外在的喧嚣。水星与海王星的和谐相位为你带来敏锐的直觉和丰富的想象力。适合深入思考、创作或与内心对话。不必急于表达，沉默中自有答案浮现。',
      'advice': '沉淀自我，厚积薄发',
      'avoid': '急功近利，操之过急',
      'score': 72,
      'love': 65,
    ...
    {
      'title': '星辰引路 顺势而为',
      'description': '木星与金星的合相照耀着你的社交宫位，今天是拓展人脉、收获善意的好时机。微笑是最好的名片，真诚是最强的磁场。顺应直觉的指引，该说的话自然会在对的时刻出口。',
      'advice': '顺应自然，借力前行',
      'avoid': '逆流而上，孤注一掷',
      'score': 78,
      'love': 72,
